	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Classes" Type="Folder">
			<Item Name="Ammeter (Parent)" Type="Folder">
				...
				<Item Name="ACS759 (Child)" Type="Folder">
					<Item Name="ACS759.lvclass" Type="LVClass" URL="../../Classes/Ammeter/ACS759/ACS759.lvclass"/>
				</Item>
			...
			<Item Name="ESC (Parent)" Type="Folder">
				...
				<Item Name="ExceedRC Volcano Series (Child)" Type="Folder">
					<Item Name="Exceed RC Volcano Series.lvclass" Type="LVClass" URL="../../Classes/ESC/Exceed RC Volcano Series/Exceed RC Volcano Series.lvclass"/>
				</Item>
				<Item Name="ESC.lvclass" Type="LVClass" URL="../../Classes/ESC/ESC.lvclass"/>
			</Item>
			<Item Name="Scale (Parent)" Type="Folder">
				<Item Name="OHAUS AV8101 (Child)" Type="Folder">
